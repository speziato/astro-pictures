...
type HEXRGBColor = {
  red: HexEncodedNumber;
  green: HexEncodedNumber;
  blue: HexEncodedNumber;
  alpha?: HexEncodedNumber;
};

export const rgbaColor: (color: HEXRGBColor) => HEX = color => {
